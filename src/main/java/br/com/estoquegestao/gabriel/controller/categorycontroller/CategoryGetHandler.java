...
public class CategoryGetHandler implements HttpHandler {
    private static final Logger logger = LoggerFactory.getLogger(CategoryGetHandler.class);
    private final ObjectMapper mapper = new ObjectMapper();
    private final CategoryDAO categoryDAO;

    public CategoryGetHandler(CategoryDAO categoryDAO) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try{
            ...
            byte[] response = mapper.writeValueAsBytes(categories);

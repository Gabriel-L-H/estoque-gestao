...
public class CategoryGetIdHandler implements HttpHandler {
    private static final Logger logger = LoggerFactory.getLogger(CategoryGetIdHandler.class);
    private final ObjectMapper mapper = new ObjectMapper();
    private final CategoryDAO categoryDAO;

    public CategoryGetIdHandler(CategoryDAO categoryDAO) {

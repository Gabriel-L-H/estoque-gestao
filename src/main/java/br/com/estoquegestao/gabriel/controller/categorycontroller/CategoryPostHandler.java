...
public class CategoryPostHandler implements HttpHandler {
    private static final Logger logger = LoggerFactory.getLogger(CategoryPostHandler.class);
    private final ObjectMapper mapper = new ObjectMapper();
    private final CategoryService categoryService;

    public CategoryPostHandler(CategoryService categoryService) {
